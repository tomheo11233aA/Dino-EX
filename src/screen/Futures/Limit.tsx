...
import { typeTradeFuturesSelector } from '@selector/futuresSelector'
        ...
        <Box zIndex={9}>
            ...
            {down &&
                ...
                >
                    <Btn
                        onPress={() => {
                            dispatch(futuresSlice.actions.setTypeTrade('Limit'))
                            setDown(false)
                        }}
                        marginVertical={5}
                    >
                    ...
                    <Btn
                        onPress={() => {
                            dispatch(futuresSlice.actions.setTypeTrade('Market'))
                            setDown(false)
                        }}
                        marginVertical={5}
                    >
