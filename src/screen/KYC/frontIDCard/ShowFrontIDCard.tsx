...
import { HEIGHT_RECT } from './FrontIDCard'
import { setFrontCard, setStep } from '@slice/kycSlice'
...
const ShowFrontIDCard = ({ path, setPath }: Props) => {
    ...
    return (
        <Box flex={1} padding={20} backgroundColor={theme.bg}>
            ...
            <Box alignCenter>
                <Btn onPress={() => dispatch(setFrontCard(path))}>
                    <Txt
                        marginBottom={20}
                        color={theme.black}
...
export default ShowFrontIDCard